...
const ArticleDetails = () => {
  ...
  const handleShare = (platform) => {
    ...
    const text = article.content.substring(0, 100); // First 100 characters of the article
  ...
  // Loading state
  if (loading) return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-[#3E4A56] to-[#CECAB3]/30">
        ...
        <div className="p-8">
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-blue-600 text-white rounded-full flex items-center hover:bg-blue-700 transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 rtl:ml-2" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-blue-400 text-white rounded-full flex items-center hover:bg-blue-500 transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 rtl:ml-2" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-blue-800 text-white rounded-full flex items-center hover:bg-blue-900 transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 rtl:ml-2" viewBox="0 0 24 24" fill="currentColor">
    ...
    comments.map((comment) => (
      <div key={comment._id} className="bg-white p-5 rounded-lg shadow-sm border-l-4 rtl:border-r-4 rtl:border-l-0 border-[#3E4A56]">
        <div className="flex items-center mb-2">
          ...
          <p className="font-medium text-[#3E4A56]">
