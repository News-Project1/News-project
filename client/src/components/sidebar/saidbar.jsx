...
function Sidebar() {
  ...
  const articles = {
    today: [
      { id: 1, title: 'لمرضى السكري... ابتعدوا عن هذه الفواكه في الصيف', number: 1 },
      { id: 2, title: 'ما علامات نقص الكالسيوم في الجسم؟', number: 2 },
      { id: 3, title: 'ما أبرز بنود الإعلان الدستوري الذي وقعه الرئيس السوري؟', number: 3 },
      { id: 4, title: 'كيف تحسن نومك في 7 أيام فقط؟', image: '', number: 4 },
